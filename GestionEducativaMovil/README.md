...
* **Entorno Integrado**: Android Studio Hedgehog (2023.1.1) o una versión superior.
* **Kit de Desarrollo**: Java Development Kit (JDK) 17 o superior.
...
📂 `app/src/main/java/com/gestion/educativa/di/AppModule.kt`
...
```
app/src/main/java/com/gestion/educativa/
│
...
Para compilar la aplicación y generar el archivo APK ejecutable de depuración, ejecute la siguiente instrucción desde la consola de comandos en la raíz del proyecto:
...
1. Habilite el menú de **Opciones de desarrollador** en su teléfono (Configuración -> Acerca del teléfono -> Pulse 7 veces el Número de compilación).
2. Active la opción **Depuración por USB**.
3. Conecte el teléfono a su computadora mediante un cable de datos.
4. En Android Studio, seleccione su dispositivo en el menú desplegable superior y pulse **Run (Shift+F10)**.
